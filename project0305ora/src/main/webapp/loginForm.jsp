        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                <a class="nav-link" href="loginForm.jsp">Link</a>
              </li>
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a class="dropdown-item" href="loginForm.jsp">회원정보</a></li>
                  <li><a class="dropdown-item" href="board.jsp">게시판</a>
...
<main class="form-signin w-100 m-auto">
  <form action="loginAction.jsp"
    ...
    <div class="form-floating">
		 ...
		 <input type="text" class="form-control" id="floatingInput" placeholder="아이디" name="memberID" maxlength="20"/>
    ...
    <div class="form-floating">
       ...
       <input type="text" class="form-control" id="floatingPassword" placeholder="비밀번호" name="memberPassword" maxlength="20"/>
    ...
    <input action="join.jsp" type="button" name="회원가입" 
    value="회원가입" 
