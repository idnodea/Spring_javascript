...
<link href="assets/dist/css/bootstrap.min.css" rel="stylesheet">
    ...
    transition: all 1s cubic-bezier(0.19, 1, 0.22, 1);}
        .header>.menu_logo{margin: 1vw 0 0 2vw;max-width: ;width: 12vw; cursor: pointer;}
        ...
        display:;}
        .header .login_box>.login_btn{width: 100%; height: 9vh; display: flex;}
...
.header .login_box>.login_btn a:hover {
    text-decoration: ; /* 호버 시 밑줄 표시 */
    /* 추가적인 호버 효과가 필요하면 여기에 작성 */
    
    transition-duration :2s;
    transition-timimg-function: ease;
    color:#c0c0c0;
}
.header .login_box>.login_btn a.login_btn_a1 {
   background-image: linear-gradient(90deg, #860404 0%, #c51212 100%);
}
.header .login_box>.login_btn a.login_btn_a2 {
   background-image: linear-gradient(90deg, #860404 100%, #c51212 0%);
}
.header .login_box>.login_btn a.login_btn_a1:hover {
    background-image: linear-gradient(90deg, #860404 100%, #c51212 0%);
}

.header .login_box>.login_btn a.login_btn_a2:hover {
    background-image: linear-gradient(90deg, #860404 0%, #c51212 100%);
}*/
/*
        .header .login_box>.login_btn p{font-size: vw; text-align: center;
    ...
    */     
    ...
    transition: all 330ms;}
        ...
        .home_menu{:; width:100%; margin: 0 auto; display:none; position: fixed; top:100px; left: 0px; background-color: black; z-index: 12}
    ...
    left: 0;}
      ...
      /*section4*/
        ...
        .pop_black{display: none; width:100vw; height: 100vh; background-color: rgba(0,0,0,0.8); position: fixed; top: 0; left: 0; z-index: 10; max-width: ;}
        .pop_group{display: none; width: 100vw; height: 100vh; background-color: rgba(0,0,0,0.8); position: fixed; top:0; left: 0; display: flex; align-items: center; justify-content: center; z-index: 11; max-width: ;}
...
<div class="warp">
 ...
 <!--   <div class="login_box">
    <div class="login_btn">
        ...
        <a href="memberForm.jsp">SignUp</a>
        <a href="list.jsp">회원정보</a>
        <a href="login-sessionLogout.jsp">Logout</a>
    </div>
</div>  -->
	<div class="login_box">
        <div class="login_btn">
            <% if(session.getAttribute("MEMBER") != null) { %>
                <!-- 로그인된 상태, 로그아웃 버튼 표시 -->
                <a href="login-sessionLogout.jsp" class="login_btn_a1">Logout</a>
                <a href="Mlist.do" class="login_btn_a2">회원정보</a>
            <% } else { %>
                <!-- 로그아웃 상태, 로그인 및 회원가입 버튼 표시 -->
                <a href="loginForm.do" class="login_btn_a1">Login</a>
                <a href="memberForm.do" class="login_btn_a2">SignUp</a>
            <% } %>
        </div>
    </div>
...
<div class="content content3" onclick="trailer3()">
    ...
    <video id="mainVideo" src="Devil May Cry 5 - Game Movie (All Cutscenes) 2019.mp4" muted autoplay loop ></video>
	</div>
    </section>
