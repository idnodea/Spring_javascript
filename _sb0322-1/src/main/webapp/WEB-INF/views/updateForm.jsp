	...
	<table>
		<form method="post" action="input">
			<tr>
				...
				<td><input type="text" name="empno" value="${member.empno}"/></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input type="text" name="hiredate"  value="${member.hiredate}"/></td>
			</tr>
			<tr>
				<td><label for="sal">월급</label></td>
				<td><input type="text" name="sal"  value="${member.sal}"/></td>
			</tr>
			<tr>
				<td><label for="comm">보너스</label></td>
				<td><input type="text" name="comm"  value="${member.comm}"/></td>
			</tr>
			<tr>
				<td><label for="deptno">부서번호</label></td>
				<td><input type="text" name="deptno"  value="${member.deptno}"/></td>
			</tr>
			<tr>
				<td></td>
